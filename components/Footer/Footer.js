export default function Footer({ ref }) {
  return (
    <footer
      ref={ref}
      id="contact"
      class="px-4 divide-y dark:bg-gray-800 dark:text-gray-100 mt-20"
    >
      <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div class="lg:w-1/3 text-baseColor">
          <a
            ...
            href="#"
            class="flex justify-center items-center space-x-3 lg:justify-start"
          >
        ...
        <div class="grid grid-cols-2 text-center text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4 sm:text-left">
          <div class="space-y-3">
          ...
          <div class="space-y-3">
            ...
            <div class="flex justify-center space-x-3 sm:justify-start">
              <a
                rel="noopener noreferrer"
                href="#"
                title="Facebook"
