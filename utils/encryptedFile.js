...
export async function uploadFileEncrypted(file, ipfspath) {
  try {
...
export async function downloadFileEncrypted(ipfspath) {
  try {
...
export async function _testing() {
  const file = "block.png"; // file to upload
