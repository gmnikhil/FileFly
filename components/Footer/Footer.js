export default function Footer({ ref }) {
  return (
    <footer
      ref={ref}
      id="contact"
      className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100 mt-20"
    >
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3 text-baseColor">
          ...
          >
            ...
            <span className="self-center !-ml-2 text-2xl font-semibold">
              FileFly
            </span>
          </a>
        </div>
        <div className="grid grid-cols-2 text-center text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4 sm:text-left">
